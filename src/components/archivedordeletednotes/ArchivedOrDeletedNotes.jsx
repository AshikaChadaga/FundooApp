...
// export default function ArchivedOrDeletedNotes(props) {
...
//                             </div>
//                             <div className="icons">
//                                 <NotesIcon handleClose={handleClose} setIsDeleted={setIsDeleted} setIsArchived={setIsArchived} displayNote={props.displayNote} setColor={setColor} mode="update" />
//                             </div>
//                         </Paper>
//                     </Box>
//                 ))}
...
export default function Notes(props) {
    ...
    const takenotes = (
        <Box sx={{ display: "flex", maxWidth: "1vw" }}>
            <InputBase onChange={(e) => setTitle(e.target.value)} defaultValue={title} placeholder="Title" sx={{ flexGrow: "1" }} />
            <IconButton>
                <PushPinOutlinedIcon />
            </IconButton>
            ...
            if (note.collaborators.length === 0) return null;
                ...
                return (
                    note.collaborators.map((eachCollab) => (
                        <span><Avatar size="small" sx={{ width: 40, height: 40, bgcolor: blueGrey[400], marginRight: "3px" }}>{eachCollab.firstName.charAt(0)}</Avatar></span>
                    ))
                );
            }
        }
    ...
    // console.log("Notes.collaboratr: ", props.note.collaborators);
    return (
        <div>
            <div className="notesdiv">
                {noteDiv()}
